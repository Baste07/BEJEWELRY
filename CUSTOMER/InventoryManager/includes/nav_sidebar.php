...
$active = $GLOBALS['NAV_ACTIVE'] ?? 'inventory';
...
?>
  <aside class="sidebar">
    ...
    <div class="sb-user">
      <div class="sb-av" id="sbAvatar">IM</div>
      <div>
        <div class="sb-uname" id="sbUsername">Loading…</div>
        <div class="sb-urole" id="sbUserRole">Inventory Manager</div>
      </div>
    </div>
    <nav>
      ...
      <a class="sb-item <?= $na('products') ?>" href="products.php"><span class="sb-icon">💎</span> Products</a>
      <hr class="sb-div">
    </nav>
